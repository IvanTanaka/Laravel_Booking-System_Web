          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" data-inputmask="'mask': ['9999-9999-9999 [x99999]', '+62999-9999-9999']" data-mask="" im-insert="true" id="store_phone_number" name="store_phone_number">
              </div>
              <!-- /.input group -->
            </div>
