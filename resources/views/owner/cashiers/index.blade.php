      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h1 class="m-0 text-dark">Cashier Management
              <a href="{{route('cashiers.create')}}" class="btn btn-success float-right"><i class="fas fa-plus"></i> Add Cashier</a>
              </h1>
          </div>
          <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body table-responsive p-2">
                            <table class="table table-bordered data-table" id="cashier_table">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Name</th>
...
<script type="text/javascript">
    $(function () {
        var table = $('#cashier_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{url('cashiers')}}",
            columns: [
    ...
    $('#deleteConfirmation').on('shown.bs.modal', function(event) {
        ...
        id = link.data("id"),
        name = link.data("name");
        modal.find("#deleteId").attr('action','cashiers/'+id);
