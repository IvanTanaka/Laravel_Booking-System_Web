              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input placeholder="eg. John Doe" type="text" class="form-control" im-insert="true" id="bank_account_name" name="bank_account_name" required>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input placeholder="eg. 9876543xxxxx" type="text" class="form-control" im-insert="true" id="bank_account_number" name="bank_account_number" required>
                    </div>
                  </div>
                </div>
              </div>
